...
public slots:
	...
	void ThreadFinished(int thCount, filesystem::path fpath)
	{
		auto info = QString::fromUtf8("线程" + to_string(thCount) + "处理完毕: ") + QString::fromStdWString(fpath.filename().wstring());
