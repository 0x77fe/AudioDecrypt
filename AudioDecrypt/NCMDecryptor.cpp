...
void Decryptor::NCMDecryptor(const filesystem::path& originalFilePath)
{
	...
	{
		outoriginalFilePath = _outputPath + "\\" + wideFilename;
	}
	...
	SetMusicInfo(outoriginalFilePath, info, _write163Key);
}